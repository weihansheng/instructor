...
import itstudio.instructor.adapter.ListViewSlidingBtnAdapter;
...
public class MainUserInfoActivity extends Activity implements
	...
	private ListViewSlidingBtnAdapter mAdapter;
	...
	protected void initView() {
		...
		mListView = (XListView) findViewById(R.id.listviewTest);

		DisplayMetrics dm = new DisplayMetrics();
		getWindowManager().getDefaultDisplay().getMetrics(dm);

		mAdapter = new ListViewSlidingBtnAdapter(this, data,
