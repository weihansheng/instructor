package itstudio.instructor.image.local;
...
public class localImageFirstActivity extends Activity {
		...
		public void handleMessage(Message msg) {
			...
			case SCAN_OK:
				...
				if(list!=null){
					...
					Toast.makeText(getApplicationContext(), R.string.photo_none, Toast.LENGTH_SHORT).show();
				}
				break;
			}
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mGroupGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				startActivityForResult(mIntent, SendNewsActivity.RESULT_LOCAL_IMG);
			}
		});
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(resultCode==RESULT_OK){
			setResult(SendNewsActivity.RESULT_LOCAL_IMG,data);
			System.out.println(data.getStringArrayListExtra("alredyChoose").size()+"fhsdjfhsdjfhsdjfhdsjh");
		}
		finish();
	}
}
